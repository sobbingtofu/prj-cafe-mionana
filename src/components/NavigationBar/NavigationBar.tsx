...
function NavigationBar() {
  ...
  return (
    <>
      {/* 고정된 가로선 - 하단 */}
      <div className="absolute bottom-20 left-1/2 -translate-x-1/2 w-[80%] h-px bg-gray-100 z-30" />

      <div
        className="absolute bottom-12 left-1/2 -translate-x-1/2 z-50 flex justify-center select-none
