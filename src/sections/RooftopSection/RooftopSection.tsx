    ...
    <section className="h-screen w-full flex items-center justify-center relative ">
      <div className="absolute z-20 w-[80%] h-[70%] flex justify-center items-start ">
        ...
        >
          ...
          >
            <h3 className={`${nanumMyeongjo.className} text-md md:text-lg font-bold text-wrap`}>
              따스한 햇살과 아래에서 여유로운 커피 한 잔의 시간을 가져보세요.
            </h3>

            <p className="text-sm mt-6 text-wrap">미오앤나나 방문객이라면 누구나 자유롭게 이용할 수 있습니다.</p>
            <p className="text-sm mt-2 text-wrap ">대관 및 콜키지 이용도 가능합니다.</p>
          </div>
        </div>
      </div>
