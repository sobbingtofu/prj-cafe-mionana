...
function MainSection() {
  ...
  return (
    <section className="h-screen w-full flex items-center justify-center relative ">
      ...
      >
        <h1 className={`${nanumMyeongjo.className} text-white text-8xl font-extrabold`}>
          {selectedLanguage === "Korean" ? "미오앤나나" : "Cafe Mio & Nana"}
        </h1>

        <p className={`${nanumMyeongjo.className} text-white text-[20px] mt-7`}>
        ...
        <div className="flex mt-30 items-center w-[60%] justify-between">
          ...
          <div className={`${chironGoRoundTc.className} w-[300px] flex flex-col items-start text-white gap-2`}>
            ...
            <p className={`italic ${selectedLanguage === "Korean" ? "text-sm" : "text-xs"} `}>
              {selectedLanguage === "Korean"
